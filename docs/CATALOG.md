...
| `runbooks/asyncio-systemexit.md` | current | operations | Handling SystemExit in asyncio contexts. |
| `runbooks/mcp-client-serialization.md` | current | operations | MCP client list-type serialization patterns. |
| `runbooks/otel-protobuf-crash.md` | current | operations | OpenTelemetry protobuf crash workaround. |
| `runbooks/transient-loop-singletons.md` | current | operations | Transient event-loop singleton issues. |
